...
def render(
    ...
    try:
        ...
        print("Run: cd .github/skills/excalidraw-diagram-skill/scripts && uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    # Template path (assets/ directory, sibling to scripts/)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run: cd .github/skills/excalidraw-diagram-skill/scripts && uv run playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
