...
- **playwright-cli skill** — You have full browser automation via the `playwright-cli` commands: open, goto, click, type, fill, snapshot, screenshot, and more. Use `playwright-cli open <url>` to start a browser session.
